                ...
                <div className=" p-4 space-y-4">
                    <div className=" h-13.75 p-4 rounded-[15px] flex items-center justify-between">
                        <div className="space-y-1">
                            <h2 className="font-semibold  text-lg leading-7 text-[#0F0F0E]">Submit a lesson</h2>
                    ...
                    <div>
                        <div className=" px-4 pt-1.5 bg-white border  border-[#D9D9D9] rounded-[10px]">
                            ...
                            <div className="mb-3 grid grid-cols-2 items-start gap-5 pb-[25px] border-b border-[#D9D9D9]">
                                {/* Subject */}
                            ...
                            <div className="flex items-center justify-end gap-2 pt-[31px] pb-[60px]">
                                <button className=" border border-[#3A3A3A80]   px-6 py-3 font-medium text-sm rounded-md cursor-pointer">
                                    <span className="text-[#3A3A3A80] font-semibold text-base">
                                        Close {" "}
                                    </span>
                                </button>
                                <button className=" border border-[#3A3A3A80]   px-6 py-3 font-medium text-sm rounded-md cursor-pointer">
                                ...
                                <button onClick={() => setOpen(true)} className="bg-chestnut  px-4 py-3 flex items-center gap-1  font-medium text-sm rounded-md cursor-pointer">
