            ...
            <div className="backdrop-blur-sm rounded-2xl border border-white/70  overflow-hidden">
                ...
                <div
                    ...
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-white font-semibold text-sm">Register Class</span>
                    </div>
                    {/* Three-dot */}
                    <EllipsisVertical />
                </div>
                    ...
                    <div className="relative z-10 flex flex-col items-center px-6 pt-8 pb-6 flex-1">
                        <div className="relative w-52 h-44 flex items-center justify-center mb-2 shrink-0">
                            ...
                            <div className="absolute flex items-center gap-1 bg-white rounded-full p-2"
                                ...
                                <span className="text-[11px] flex items-center font-semibold text-chestnut"><PlusIcon className="size-3" />  junior Secondary</span>
                            </div>

                            {/* + Basic  — right */}
                            <div
                                className="absolute flex items-center gap-1 bg-white p-2 rounded-full" style={{ top: "50%", right: -17, transform: "translateY(-50%)" }}>
                                <span className="text-[11px] flex items-center  font-semibold text-chestnut"><PlusIcon className="size-3" /> Basic </span>
                            </div>

                            <div
                                className="absolute flex items-center gap-1 bg-white p-2 rounded-full" style={{ bottom: 24, left: -30 }}>
                                <span className="text-[11px] flex items-center font-semibold text-chestnut"><PlusIcon className="size-3" />High School</span>
                            </div>
                        </div>
                        ...
                        <p className="text-sm text-chestnut/50 text-center  leading-relaxed mb-6">
                            Greenfield College doesn't have any Class set up yet. Add your first class
                        ...
                        <div className="grid grid-cols-2 gap-6 mb-8 w-full">
                            ...
                            <div className="flex flex-col items-center text-center gap-2">
                                ...
                                <p className="text-sm font-semibold text-[#12122A]">Add a Class</p>
                                <p className="text-[11px] text-chestnut/50 leading-snug">
                                    Enter the class name and
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-[11px] text-gray-400">
                                You can add multiple class one after another
                            </span>
                        </div>
                    </div>
                </div>
