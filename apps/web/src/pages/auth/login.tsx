    ...
    <div className="font-poppins">
      ...
      <div className="mb-1">
        <span className="text-sm font-semibold text-chestnut">
          {schoolName ? `Welcome — ${schoolName}` : "Welcome to Bluethub"}
        </span>
      </div>
      <div className="flex mb-6">
        <span className="bg-chestnut px-10 py-2 rounded-full text-white text-sm font-semibold shadow select-none">
          Login
        </span>
      </div>
      <p className="text-center text-gray-400 text-sm mb-6 tracking-widest">
      ...
      <form onSubmit={handleSubmit(handleLogin)} className="space-y-5" noValidate>
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-full px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-chestnut focus:border-chestnut"
          />
          {errors.userName && (
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full border border-gray-300 rounded-full px-4 py-2.5 pr-11 text-sm outline-none focus:ring-2 focus:ring-chestnut focus:border-chestnut"
            />
            <button
              type="button"
        ...
        <div className="flex items-center justify-between">
          ...
          <button type="button" className="text-sm text-chestnut hover:underline">
            Forgot Password?
          </button>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="bg-chestnut w-full py-3 rounded-full text-white text-sm font-semibold shadow hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {loading ? (
            <>
